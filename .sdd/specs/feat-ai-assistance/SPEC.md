...
WHEN Student click "Explain with AI",THE SYSTEM SHALL collect:
...
WHEN chatbot message được lưu,THE SYSTEM SHALL persist:
...
WHERE AI Service unavailable,THE SYSTEM SHALL hiển thị:
