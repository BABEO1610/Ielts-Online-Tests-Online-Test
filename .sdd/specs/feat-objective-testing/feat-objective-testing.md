...
- **Audit Logging (Ghi vết hệ thống):** Bất kỳ hành động thay đổi nào từ Tutor đối với đề thi đã được publish (ví dụ: cập nhật đáp án, sửa nội dung câu hỏi, xóa mềm) đều bắt buộc phải được ghi log (lưu lại ID người sửa, thời gian thực hiện thao tác, và chi tiết nội dung thay đổi) để phục vụ cho việc quản trị và đối soát.
...
- Giả định phần Audio của Listening là một file MP3/WAV tổng kéo dài khoảng 30-40 phút, học viên tự thao tác Play/Pause, hệ thống không tự động cắt nhỏ file audio theo từng section.
