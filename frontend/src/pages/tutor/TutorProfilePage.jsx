...
const TutorProfilePage = () => {
  ...
  return (
    <div className="py-4 px-3 px-md-4">
      <div className="mb-4">
        <h1 className="display-md mb-1">Hồ sơ cá nhân (Tutor)</h1>
        <p className="body-sm text-secondary m-0">Quản lý thông tin tài khoản giáo viên của bạn.</p>
      </div>
        ...
        <div className="col-lg-4">
          <div className="admin-card h-100">
            <div className="admin-card__body text-center">
              ...
              <h2 className="display-sm mb-1">{user.full_name || 'Tutor'}</h2>
              <div className="body-sm text-secondary mb-3">{user.email}</div>
              <div className="d-flex justify-content-center gap-2">
                <span className={`pill ${rolePill(user.role || 'tutor')}`}>{user.role || 'tutor'}</span>
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="mb-4">
                  ...
                  <input type="url" className="form-control" name="avatar_url" placeholder="https://…"
                    value={form.avatar_url} onChange={handleChange} />
                </div>
                <button type="submit" className="btn-pill btn-pill--dark px-4" disabled={loading}>
          ...
          <div className="admin-card">
            ...
            <div className="admin-card__body">
              <div className="row g-3">
                ...
                <div className="col-sm-6"><span className="caption text-secondary d-block">Vai trò</span><span className="body-md-strong text-capitalize">{user.role || 'tutor'}</span></div>
